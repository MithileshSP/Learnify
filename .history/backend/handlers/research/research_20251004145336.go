...
func normalizeResearchCategory(raw string, isCollaboration bool) string { category := strings.TrimSpace(raw); if category == "" { if isCollaboration { return "Collaboration" }; return "My Research" }; switch strings.ToLower(category) { case "collaboration","collaborations","collab","team-up": return "Collaboration"; case "my research","research","personal": return "My Research"; case "trending": return "Trending"; default: return category } }F
