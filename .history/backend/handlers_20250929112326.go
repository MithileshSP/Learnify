...
const GEMINI_API_KEY = "AIzaSyBC9uPmMncc1_iQ2aVQYEPR7Oeb70Kz51I"
...
func callGeminiAPI(message string) (string, error) {
    url := fmt.Sprintf("https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=%s", GEMINI_API_KEY)
