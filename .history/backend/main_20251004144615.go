...
func main() {
	...
	// AI chat & research endpoints still pending extraction -> temporarily disable or point to placeholder if added
	// protected.HandleFunc("/ai/chat", aiHandlers.Chat).Methods("POST") (future)
