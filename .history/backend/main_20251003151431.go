...
func main() {
	...
	protected.HandleFunc("/student/dashboard", getStudentDashboard).Methods("GET")
	protected.HandleFunc("/admin/overview", getAdminOverview).Methods("GET")
	protected.HandleFunc("/faculty/overview", getFacultyOverview).Methods("GET")
