...
func insertSampleData() {
	...
	if err != nil {
		...
		now := time.Now().UTC()
		aaSuggestionID := primitive.NewObjectID()
		aSuggestionTwoID := primitive.NewObjectID()
		aaSuggestionThreeID := primitive.NewObjectID()
