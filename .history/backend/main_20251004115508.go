...
import (
	...
	apphandlers "github.com/MithileshSP/Learnify/backend/handlers"
	"github.com/MithileshSP/Learnify/backend/middleware"
)
...
func main() {
	...
	protected.HandleFunc("/quests", apphandlers.GetQuests).Methods("GET")
