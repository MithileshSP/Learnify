              ...
              <div className="space-y-4">
                {analytics.labels.map((label, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify_between text-sm font-medium text-slate-700">
                        <span>{label}</span>
              ...
              {loading ? (
                ...
                topPerformers.map((leader, index) => (
                  <div
                    ...
                    className="flex items-center justify_between border border-slate-200 rounded-2xl px-4 py-3"
                  >
                    <div>
