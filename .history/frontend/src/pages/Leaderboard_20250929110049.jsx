  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-yellow-500 to-orange-500 rounded-2xl p-8 text-white">
        ...
        <p className="text-white/90">See who’s leading in learning this week!</p>
      </div>
          ...
          <tbody>
            {leaderboard.map((player, idx) => (
              ...
              >
                ...
                <td className="px-6 py-4 font-semibold text-yellow-600">{player.coins}</td>
                <td className="px-6 py-4">{player.achievements.join(', ')}</td>
              </tr>
            ))}
          </tbody>
        </table>
